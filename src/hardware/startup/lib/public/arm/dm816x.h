...
/* This gives the status of the boot mode pins on the a15
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/dm816x.h $ $Rev: 733817 $")
#endif
