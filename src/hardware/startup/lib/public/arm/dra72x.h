...
/*
 * TI DRA72X processor with ARMv7 Cortex-A15 core
 */

#ifndef __ARM_DRA72X_H_INCLUDED
#define __ARM_DRA72X_H_INCLUDED

/* Memory address global mapping */
#define DRA72X_MPU_ROM                          0x40038000
#define DRA72X_OCMC_RAM1                        0x40300000
    #define DRA72X_OCMC_RAM1_SIZE               (512 * 1024)
#define DRA72X_OCMC_RAM2                        0x40400000
    #define DRA72X_OCMC_RAM2_SIZE               (1024 * 1024)
#define DRA72X_OCMC_RAM3                        0x40500000
    #define DRA72X_OCMC_RAM3_SIZE               (1024 * 1024)
#define DRA72X_QSPI_SFI_MM_BASE                 0x5C000000
#define DRA72X_QSPI_SFI_MM_SIZE                 (64 * 1024 * 1024)
#define DRA72X_EMIF_CS0_BASE                    0x80000000

#define DRA72X_QSPI_CORE_BASE                   0x4B300000
#define DRA72X_QSPI_CORE_SIZE                   0x1000
...
#define DRA72X_SGI0_IRQ                         0
#define DRA72X_SGI1_IRQ                         1
#define DRA72X_SGI2_IRQ                         2
#define DRA72X_SGI3_IRQ                         3
#define DRA72X_SGI4_IRQ                         4
#define DRA72X_SGI5_IRQ                         5
#define DRA72X_SGI6_IRQ                         6
#define DRA72X_SGI7_IRQ                         7
#define DRA72X_SGI8_IRQ                         8
#define DRA72X_SGI9_IRQ                         9
#define DRA72X_SGI10_IRQ                        10
#define DRA72X_SGI11_IRQ                        11
#define DRA72X_SGI12_IRQ                        12
#define DRA72X_SGI13_IRQ                        13
#define DRA72X_SGI14_IRQ                        14
#define DRA72X_SGI15_IRQ                        15

#define DRA72X_GLOBAL_TIMER_IRQ                 27
#define DRA72X_LEGACY_NFIQ_IRQ                  28
#define DRA72X_PRIVATE_TIMER_IRQ                29
#define DRA72X_PRIVATE_WDTIMER_IRQ              30
#define DRA72X_LEGACY_NIRQ_IRQ                  31

// IRQs defined in the DRA7xx TRM are Shared Peripheral Interrupts that
// start 32 entries into the interrupt of the GIC
#define DRA72X_NUM_INTERNAL_IRQS                32

#define DRA72X_CLUSTER_IRQ_INTERR               (0 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_CTI_IRQ_0                        (1 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_CTI_IRQ_1                        (2 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_CLUSTER_IRQ_AXIERR               (3 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_ELM_IRQ                          (4 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_WD_TIMER_MPU_C0_IRQ_WARN         (5 + DRA72X_NUM_INTERNAL_IRQS)
//External External interrupt 1 (active low)
#define DRA72X_SYS_NIRQ1                        (7 + DRA72X_NUM_INTERNAL_IRQS)
// L3 interconnect debug error
#define DRA72X_L3_DBG_IRQ                       (9 + DRA72X_NUM_INTERNAL_IRQS)
// L3 interconnect application error
#define DRA72X_L3_APP_IRQ                       (10 + DRA72X_NUM_INTERNAL_IRQS)
// PRCM interrupt
#define DRA72X_PRCM_MPU_IRQ                     (11 + DRA72X_NUM_INTERNAL_IRQS)
// SDMA SDMA interrupt 0
#define DRA72X_SDMA_IRQ_0                       (12 + DRA72X_NUM_INTERNAL_IRQS)
// SDMA SDMA interrupt 1
#define DRA72X_SDMA_IRQ_1                       (13 + DRA72X_NUM_INTERNAL_IRQS)
// SDMA SDMA interrupt 2
#define DRA72X_SDMA_IRQ_2                       (14 + DRA72X_NUM_INTERNAL_IRQS)
// SDMA SDMA interrupt 3
#define DRA72X_SDMA_IRQ_3                       (15 + DRA72X_NUM_INTERNAL_IRQS)
// L3_MAIN_IRQ_STAT interrupt
#define DRA72X_L3_MAIN_IRQ_STAT_ALARM           (16 + DRA72X_NUM_INTERNAL_IRQS)
// GPMC interrupt
#define DRA72X_GPMC_IRQ                         (20 + DRA72X_NUM_INTERNAL_IRQS)
// 2D/3D graphics module interrupt
#define DRA72X_SGX_IRQ                          (21 + DRA72X_NUM_INTERNAL_IRQS)
// Display controller Display controller interrupt
#define DRA72X_DSS_DISPC_IRQ                    (25 + DRA72X_NUM_INTERNAL_IRQS)
// Mailbox user 0 interrupt
#define DRA72X_MAIL_U0_MPU_IRQ                  (26 + DRA72X_NUM_INTERNAL_IRQS)
// DSP MMU interrupt
#define DRA72X_DSP_MMU_IRQ                      (28 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO1 MPU interrupt
#define DRA72X_GPIO1_MPU_IRQ                    (29 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO2 MPU interrupt
#define DRA72X_GPIO2_MPU_IRQ                    (30 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO3 MPU interrupt
#define DRA72X_GPIO3_MPU_IRQ                    (31 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO4 MPU interrupt
#define DRA72X_GPIO4_MPU_IRQ                    (32 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO5 MPU interrupt
#define DRA72X_GPIO5_MPU_IRQ                    (33 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO6 MPU interrupt
#define DRA72X_GPIO6_MPU_IRQ                    (34 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO7 MPU interrupt
#define DRA72X_GPIO7_MPU_IRQ                    (35 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER1 interrupt
#define DRA72X_GPT1_IRQ                         (37 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER2 interrupt
#define DRA72X_GPT2_IRQ                         (38 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER3 interrupt
#define DRA72X_GPT3_IRQ                         (39 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER4 interrupt
#define DRA72X_GPT4_IRQ                         (40 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER5 interrupt
#define DRA72X_GPT5_IRQ                         (41 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER6 interrupt
#define DRA72X_GPT6_IRQ                         (42 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER7 interrupt
#define DRA72X_GPT7_IRQ                         (43 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER8 interrupt
#define DRA72X_GPT8_IRQ                         (44 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER9 interrupt
#define DRA72X_GPT9_IRQ                         (45 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER10 interrupt
#define DRA72X_GPT10_IRQ                        (46 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER11 interrupt
#define DRA72X_GPT11_IRQ                        (47 + DRA72X_NUM_INTERNAL_IRQS)
// MCSPI4 interrupt
#define DRA72X_MCSPI4_IRQ                       (48 + DRA72X_NUM_INTERNAL_IRQS)
// SATA interrupt
#define DRA72X_SATA_IRQ                         (54 + DRA72X_NUM_INTERNAL_IRQS)
// I2C1 interrupt
#define DRA72X_I2C1_IRQ                         (56 + DRA72X_NUM_INTERNAL_IRQS)
// I2C2 interrupt
#define DRA72X_I2C2_IRQ                         (57 + DRA72X_NUM_INTERNAL_IRQS)
// HDQ/1wire interrupt
#define DRA72X_HDQ_IRQ                          (58 + DRA72X_NUM_INTERNAL_IRQS)
// I2C5 interrupt
#define DRA72X_I2C5_IRQ                         (60 + DRA72X_NUM_INTERNAL_IRQS)
// I2C3 interrupt
#define DRA72X_I2C3_IRQ                         (61 + DRA72X_NUM_INTERNAL_IRQS)
// I2C4 interrupt
#define DRA72X_I2C4_IRQ                         (62 + DRA72X_NUM_INTERNAL_IRQS)
// MCSPI1 interrupt
#define DRA72X_MCSPI1_IRQ                       (65 + DRA72X_NUM_INTERNAL_IRQS)
// MCSPI2 interrupt
#define DRA72X_MCSPI2_IRQ                       (66 + DRA72X_NUM_INTERNAL_IRQS)
// UART module 4 interrupt
#define DRA72X_UART4_IRQ                        (70 + DRA72X_NUM_INTERNAL_IRQS)
// UART1 interrupt
#define DRA72X_UART1_IRQ                        (72 + DRA72X_NUM_INTERNAL_IRQS)
// UART2 interrupt
#define DRA72X_UART2_IRQ                        (73 + DRA72X_NUM_INTERNAL_IRQS)
// UART3 interrupt
#define DRA72X_UART3_IRQ                        (74 + DRA72X_NUM_INTERNAL_IRQS)
// Merged interrupt for PBIASlite1 and 2
#define DRA72X_PBIAS_IRQ                        (75 + DRA72X_NUM_INTERNAL_IRQS)
// HSUSB MP host interrupt OHCI controller
#define DRA72X_HSUSB_OHCI_IRQ                   (76 + DRA72X_NUM_INTERNAL_IRQS)
// HSUSB MP host interrupt EHCI controller
#define DRA72X_HSUSB_EHCI_IRQ                   (77 + DRA72X_NUM_INTERNAL_IRQS)
// HSUSB MP TLL interrupt
#define DRA72X_HSUSB_TLL_IRQ                    (78 + DRA72X_NUM_INTERNAL_IRQS)
// WDTIMER2 interrupt
#define DRA72X_WDT2_IRQ                         (80 + DRA72X_NUM_INTERNAL_IRQS)
// MMC1 interrupt
#define DRA72X_MMC1_IRQ                         (83 + DRA72X_NUM_INTERNAL_IRQS)
// MMC2 interrupt
#define DRA72X_MMC2_IRQ                         (86 + DRA72X_NUM_INTERNAL_IRQS)
// CT_UART interrupt generated when data ready on RX or when TX empty
#define DRA72X_DEBUGSS_IRQ_CT_UART              (90 + DRA72X_NUM_INTERNAL_IRQS)
// MCSPI3 interrupt
#define DRA72X_MCSPI3_IRQ                       (91 + DRA72X_NUM_INTERNAL_IRQS)
// HSUSB OTG controller interrupt
#define DRA72X_USB2_INTR1_IRQ                   (92 + DRA72X_NUM_INTERNAL_IRQS)
// HSUSB OTG DMA interrupt
#define DRA72X_USB3_INTR0_IRQ                   (93 + DRA72X_NUM_INTERNAL_IRQS)
// MMC3 interrupt
#define DRA72X_MMC3_IRQ                         (94 + DRA72X_NUM_INTERNAL_IRQS)
// GPTIMER12 interrupt
#define DRA72X_GPT12_IRQ                        (95 + DRA72X_NUM_INTERNAL_IRQS)
// MMC4 interrupt
#define DRA72X_MMC4_IRQ                         (96 + DRA72X_NUM_INTERNAL_IRQS)
// IPU1 MMU interrupt
#define DRA72X_IPU1_MMU_IRQ                     (100 + DRA72X_NUM_INTERNAL_IRQS)
// HDMI interrupt
#define DRA72X_HDMI_IRQ                         (101 + DRA72X_NUM_INTERNAL_IRQS)
// Sync interrupt from ICONT2 (vDMA)
#define DRA72X_IVA_SYNC_1_IRQ                   (103 + DRA72X_NUM_INTERNAL_IRQS)
// Sync interrupt from ICONT1
#define DRA72X_IVA_SYNC_0_IRQ                   (104 + DRA72X_NUM_INTERNAL_IRQS)
// UART5 interrupt
#define DRA72X_UART5_IRQ                        (105 + DRA72X_NUM_INTERNAL_IRQS)
// UART6 interrupt
#define DRA72X_UART6_IRQ                        (106 + DRA72X_NUM_INTERNAL_IRQS)
// IVAHD mailbox interrupt 0
#define DRA72X_IVAHD_MAILBOX_IRQ_0              (107 + DRA72X_NUM_INTERNAL_IRQS)
// McASP1 receive interrupt
#define DRA72X_MCASP1_ARINT                     (108 + DRA72X_NUM_INTERNAL_IRQS)
// McASP1 transmit interrupt
#define DRA72X_MCASP1_AXINT                     (109 + DRA72X_NUM_INTERNAL_IRQS)
// EMIF1 interrupt
#define DRA72X_EMIF1_IRQ                        (110 + DRA72X_NUM_INTERNAL_IRQS)
// DMM interrupt
#define DRA72X_DMM_IRQ                          (113 + DRA72X_NUM_INTERNAL_IRQS)
// External interrupt 2 (active low)
#define DRA72X_SYS_NIRQ2                        (119 + DRA72X_NUM_INTERNAL_IRQS)
// Keyboard controller interrupt
#define DRA72X_KBD_CTL_IRQ                      (120 + DRA72X_NUM_INTERNAL_IRQS)
// GPIO8 MPU interrupt
#define DRA72X_GPIO8_MPU_IRQ                    (121 + DRA72X_NUM_INTERNAL_IRQS)
// CAL (CSI2) Interrupt
#define DRA72X_CAL_IRQ                          (124 + DRA72X_NUM_INTERNAL_IRQS
// BB2D interrupt
#define DRA72X_BB2D_IRQ                         (125 + DRA72X_NUM_INTERNAL_IRQS)
// Control module thermal Alert interrupt
#define DRA72X_CTRL_MOD_THERMAL_IRQ             (126 + DRA72X_NUM_INTERNAL_IRQS)
// MPU core 0 PMU interrupt
#define DRA72X_MPU_0_PMU_IRQ                    (131 + DRA72X_NUM_INTERNAL_IRQS)
// NMI pin interrupt (enabled via Control Module)
#define DRA72X_NMI_IRQ                          (133 + DRA72X_NUM_INTERNAL_IRQS)
// MPU_WD_TIMER channel 0 timeout interrupt (watchdog reset)
#define DRA72X_WD_TIMER_MPU_C0_IRQ              (139 + DRA72X_NUM_INTERNAL_IRQS)

// Device interrupts that are mapped to IRQ_CROSSBAR input
/*************************************************/
#define DRA72X_EDMA_IRQ                         (49 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_PCIE_SS1_IRQ_INT0                (50 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_PCIE_SS1_IRQ_INT1                (51 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_PCIE_SS2_IRQ_INT0                (52 + DRA72X_NUM_INTERNAL_IRQS)
#define DRA72X_PCIE_SS2_IRQ_INT1                (53 + DRA72X_NUM_INTERNAL_IRQS)

/*************************************************/
/* MPU_WUGEN Register                           */
/*************************************************/
#define DRA72X_MPU_WUGEN                        0x48281000
    ...
    #define STM_HWEVENTS_INV                    0x808
    #define AMBA_IF_MODE                        0x80C
    #define TIMESTAMPCYCLELO                    0xC08
    #define TIMESTAMPCYCLEHI                    0xC0C

/*************************************************/
/* GPIO */
/*************************************************/
#define DRA72X_GPIO1_BASE                       0x4ae10000  // 0-31
#define DRA72X_GPIO2_BASE                       0x48055000  // 32-63
#define DRA72X_GPIO3_BASE                       0x48057000  // 64-95
#define DRA72X_GPIO4_BASE                       0x48059000  // 96-127
#define DRA72X_GPIO5_BASE                       0x4805b000  // 128-159
#define DRA72X_GPIO6_BASE                       0x4805d000  // 160-191
#define DRA72X_GPIO7_BASE                       0x48051000  // 192-223
#define DRA72X_GPIO8_BASE                       0x48053000  // 224-255
...
/*************************************************/
#define DRA72X_TIMER1_BASE                      0x4AE18000
#define DRA72X_TIMER2_BASE                      0x48032000
#define DRA72X_TIMER3_BASE                      0x48034000
#define DRA72X_TIMER4_BASE                      0x48036000
#define DRA72X_TIMER5_BASE                      0x48820000
#define DRA72X_TIMER6_BASE                      0x48822000
#define DRA72X_TIMER7_BASE                      0x48824000
#define DRA72X_TIMER8_BASE                      0x48826000
#define DRA72X_TIMER9_BASE                      0x4803E000
#define DRA72X_TIMER10_BASE                     0x48086000
#define DRA72X_TIMER11_BASE                     0x48088000
#define DRA72X_TIMER12_BASE                     0x4AE20000
#define DRA72X_TIMER13_BASE                     0x48828000
#define DRA72X_TIMER14_BASE                     0x4882A000
#define DRA72X_TIMER15_BASE                     0x4882C000
#define DRA72X_TIMER16_BASE                     0x4882E000

/*************************************************/
/* Real time clock */
/*************************************************/
#define DRA72X_RTC_BASE                         0x48838000
#define DRA72X_RTC_SIZE                         0x1000

#define DRA72X_RTC_SECONDS                      0x00
#define DRA72X_RTC_MINUTES                      0x04
#define DRA72X_RTC_HOURS                        0x08
#define DRA72X_RTC_DAYS                         0x0c
#define DRA72X_RTC_MONTHS                       0x10
#define DRA72X_RTC_YEARS                        0x14
#define DRA72X_RTC_WEEKS                        0x18
#define DRA72X_RTC_ALARM_SECONDS                0x20
#define DRA72X_RTC_ALARM_MINUTES                0x24
#define DRA72X_RTC_ALARM_HOURS                  0x28
#define DRA72X_RTC_ALARM_DAYS                   0x2c
#define DRA72X_RTC_ALARM_MONTHS                 0x30
#define DRA72X_RTC_ALARM_YEARS                  0x34
#define DRA72X_RTC_CTRL                         0x40
    #define DRA72X_RTC_CTRL_RTC_DISABLE         0x40
    #define DRA72X_RTC_CTRL_SET_32_CNTR         0x20
    #define DRA72X_RTC_CTRL_TEST_MODE           0x10
    #define DRA72X_RTC_CTRL_MODE_12_24          0x08
    #define DRA72X_RTC_CTRL_AUTO_COMP           0x04
    #define DRA72X_RTC_CTRL_ROUND_30S           0x02
    #define DRA72X_RTC_CTRL_STOP_RTC            0x01
#define DRA72X_RTC_STATUS                       0x44
    #define DRA72X_RTC_STATUS_ALARM             0x40
    #define DRA72X_RTC_STATUS_1D_EVENT          0x20
    #define DRA72X_RTC_STATUS_1H_EVENT          0x10
    #define DRA72X_RTC_STATUS_1M_EVENT          0x08
    #define DRA72X_RTC_STATUS_1S_EVENT          0x04
    #define DRA72X_RTC_STATUS_RUN               0x02
    #define DRA72X_RTC_STATUS_BUSY              0x01
#define DRA72X_RTC_INTERRUPTS                   0x48
#define DRA72X_RTC_COMP_LSB                     0x4c
#define DRA72X_RTC_COMP_MSB                     0x50
#define DRA72X_RTC_OSC                          0x54
    #define DRA72X_RTC_OSC_CLK_EN               0x40
    #define DRA72X_RTC_OSC_SWRESET              0x20
    #define DRA72X_RTC_OSC_OSC32KPWRDNR         0x10
    #define DRA72X_RTC_OSC_SWRESPROG_MASK       0x0F
    #define DRA72X_RTC_OSC_32CLK_SEL            0x08
    #define DRA72X_RTC_OSC_RES_SEL              0x04
    #define DRA72X_RTC_OSC_SW2                  0x02
    #define DRA72X_RTC_OSC_SW1                  0x01
#define DRA72X_RTC_SCRATCH0                     0x60
#define DRA72X_RTC_SCRATCH1                     0x64
#define DRA72X_RTC_SCRATCH2                     0x68
#define DRA72X_RTC_KICK0R                       0x6C
    #define DRA72X_RTC_UNLOCK_SEQ0              0x83e70b13
    #define DRA72X_RTC_UNLOCK_SEQ1              0x95a4f1e0
#define DRA72X_RTC_KICK1R                       0x70
#define DRA72X_RTC_REVISION                     0x74
#define DRA72X_RTC_SYSCONFIG                    0x78
#define DRA72X_RTC_IRQWAKEEN_0                  0x7A

/*************************************************/
/* UART */
/*************************************************/
#define DRA72X_UART1_BASE                       0x4806a000
#define DRA72X_UART2_BASE                       0x4806c000
#define DRA72X_UART3_BASE                       0x48020000
#define DRA72X_UART4_BASE                       0x4806e000
#define DRA72X_UART5_BASE                       0x48066000
#define DRA72X_UART6_BASE                       0x48068000
#define DRA72X_UART7_BASE                       0x48420000
#define DRA72X_UART8_BASE                       0x48422000
#define DRA72X_UART9_BASE                       0x48424000
#define DRA72X_UART10_BASE                      0x4ae2b000
#define DRA72X_UART_REG_SIZE                    0xFFF

/*************************************************/
/* Shared PHY Component Subsystem               */
/*************************************************/
/* USB3 PHY */
#define DRA72X_USB3_PHY_RX                      0x4A084400
#define DRA72X_USB3_PHY_TX                      0x4A084800
...
#define DRA72X_DPLLCTRL_USB_OTG_SS              0x4A084C00
#define DRA72X_OCP2SCP1                         0x4A080000
...
/* PCIe Shared PHY */
#define DRA72X_OCP2SCP3                         0x4a090000  /* OCP2SCP3 is shared by SATA and PCIe */

#define DRA72X_PCIe1_PHY_RX                     0x4a094000
#define DRA72X_PCIe2_PHY_RX                     0x4a095000  /* need to check if this is present */
...
/* SATA PHY subsystem */
#define DRA72X_DPLLCTRL_SATA_BASE               0x4a096800
...
#define DRA72X_OCP2SCP3_SATA_PHY_RX             0x4a096000
...
#define DRA72X_OCP2SCP3_SATA_PHY_TX             0x4a096400
...
/* MCSPI */
/*************************************************/
#define DRA72X_MCSPI1_HL_BASE                   0x48098000
#define DRA72X_MCSPI1_BASE                      0x48098100
#define DRA72X_MCSPI2_HL_BASE                   0x4809a000
#define DRA72X_MCSPI2_BASE                      0x4809a100
#define DRA72X_MCSPI3_HL_BASE                   0x480b8000
#define DRA72X_MCSPI3_BASE                      0x480b8100
#define DRA72X_MCSPI4_HL_BASE                   0x480ba000
#define DRA72X_MCSPI4_BASE                      0x480ba100
#define DRA72X_MCSPI_REG_SIZE                   0xFFF

/*************************************************/
/* I2C */
/*************************************************/
#define DRA72X_I2C1_BASE                        0x48070000
#define DRA72X_I2C2_BASE                        0x48072000
#define DRA72X_I2C3_BASE                        0x48060000
#define DRA72X_I2C4_BASE                        0x4807A000
#define DRA72X_I2C5_BASE                        0x4807C000
#define DRA72X_I2C6_BASE                        0x48458000
#define DRA72X_I2C_REG_SIZE                     0xFFF

/*************************************************/
/* MMCSD */
/*************************************************/
#define DRA72X_MMC1_BASE                        0x4809C000
#define DRA72X_MMC2_BASE                        0x480B4000
#define DRA72X_MMC3_BASE                        0x480AD000
#define DRA72X_MMC4_BASE                        0x480D1000
#define DRA72X_MMC_SIZE                         0x18000

/*************************************************/
/* SATA                                         */
/*************************************************/
#define DRA72X_SATA_BASE                        0x4A140000
#define DRA72X_SATA_WRAPPER                     0x4A141100
...
/* USB */
/*************************************************/
#define DRA72X_USB_WRAPPER1                     0x48880000
#define DRA72X_USB_WRAPPER2                     0x488C0000
#define DRA72X_USB_WRAPPER3                     0x48900000
#define DRA72X_USB_WRAPPER4                     0x48940000 /* need to check if this is present */

#define DRA72X_USB_DWC1                         0x48890000
#define DRA72X_USB_DWC2                         0x488D0000
#define DRA72X_USB_DWC3                         0x48910000
#define DRA72X_USB_DWC4                         0x48950000 /* need to check if this is present */
...
#define DRA72X_USB2PHY1                         0x4A084000
#define DRA72X_USB2PHY2                         0x4A085000

/*************************************************/
/* VIP */
/*************************************************/
#define DRA72X_VIP1_BASE                        0x48970000
#define DRA72X_VIP2_BASE                        0x48990000
#define DRA72X_VIP3_BASE                        0x489B0000

/*************************************************/
/* EDMA */
/*************************************************/
#define DRA72X_EDMA_BASE                        0x43300000
#define DRA72X_EDMA_SIZE                        0x5000
#define DRA72X_EDMA_SHADOW0_OFF                 0x2000
#define DRA72X_PARAM_OFF                        0x4000
#define DRA72X_PARAM_SIZE                       0x20
#define DRA72X_PARAM(ch)                        (DRA72X_PARAM_OFF + (DRA72X_PARAM_SIZE * ch))

/*************************************************/
/* SDMA */
/*************************************************/
#define DRA72X_SDMA_BASE                        0x4a056000

#define DRA72X_DMA4_IRQSTATUS_Lj                0x08
#define DRA72X_DMA4_IRQENABLE_Lj                0x18
#define DRA72X_DMA4_OCP_SYSCONFIG               0x2c
...
#define DRA72X_DMA4_GCR                         0x78
    #define GCR_ARBITRATION_RATE                0xff0000
    #define DMA_DEFAULT_FIFO_DEPTH              0x10
#define DRA72X_DMA4_CCRi                        0x80
#define DRA72X_DMA4_CICRi                       0x88
#define DRA72X_DMA4_CSRi                        0x8C
    #define DRA72X_DMA4_CSR_MSK                 0x5DFE

/*************************************************/
/* DMM */
/*************************************************/
#define DRA72X_DMM_BASE                         0x40000000
...
#define DRA72X_MA_BASE                          0x482AF000

/*************************************************/
/* WDTIMER2 */
/*************************************************/
#define DRA72X_WDTIMER2_BASE                    0x4ae14000
...
/* GPMC module                                      */
/****************************************************/
#define DRA72X_GPMC_BASE                        0x50000000
...
#define GPMC_CONFIG1(x)                         (0x60 + 0x30 * (x))
    #define GPMCFCLKDIVIDER                     0
    #define TIMEPARAGRANULARITY                 4
    #define MUXADDDATA                          8
    #define DEVICETYPE                          10
    #define DEVICESIZE                          12
    #define WAITPINSELECT                       16
    #define WAITMONITORINGTIME                  18
    #define WAITWRITEMONITORING                 21
    #define WAITREADMONITORING                  22
    #define PAGELENGTH                          23
    #define CLKACTIVATIONTIME                   25
    #define WRITETYPE                           27
    #define WRITEMULTIPLE                       28
    #define READTYPE                            29
    #define READMULTIPLE                        30
    #define WRAPBURST                           31
#define GPMC_CONFIG2(x)                         (0x64 + 0x30 * (x))
    #define CSONTIME                            0
    #define CSEXTRADELAY                        7
    #define CSRDOFFTIME                         8
    #define CSWROFFTIME                         16
#define GPMC_CONFIG3(x)                         (0x68 + 0x30 * (x))
    #define ADVONTIME                           0
    #define ADVAADMUXONTIME                     4
    #define ADVEXTRADELAY                       7
    #define ADVRDOFFTIME                        8
    #define ADVWROFFTIME                        16
    #define ADVAADMUXRDOFFTIM                   24
    #define ADVAADMUXWROFFTIME                  28
#define GPMC_CONFIG4(x)                         (0x6C + 0x30 * (x))
    #define OEONTIME                            0
    #define OEAADMUX_ONTIME                     4
    #define OEEXTRADELAY                        7
    #define OEOFFTIME                           8
    #define OEAADMUX_OFFTIME                    13
    #define WEONTIME                            19
    #define WEEXTRADELAY                        23
    #define WEOFFTIME                           24
#define GPMC_CONFIG5(x)                         (0x70 + 0x30 * (x))
    #define RDCYCLETIME                         0
    #define WRCYCLETIME                         8
    #define RDACCESSTIME                        16
    #define PAGEBURSTACCESSTIME                 24
#define GPMC_CONFIG6(x)                         (0x74 + 0x30 * (x))
    #define BUSTURNAROUND                       0
    #define CYCLE2CYCLEDIFFCSEN                 6
    #define CYCLE2CYCLESAMECSEN                 7
    #define CYCLE2CYCLEDELAY                    8
    #define WRDATAONADMUXBUS                    16
    #define WRACCESSTIME                        24
#define GPMC_CONFIG7(x)                         (0x78 + 0x30 * (x))
    #define GPMC_BASEADDRESS                    0
    #define CSVALID                             6
    #define GPMC_MASKADDRESS                    8
...
/* L4_WKUP_PRM */
/*************************************************/
#define DRA72X_L4_WKUP_PRM_BASE                 0x4AE06000

/*************************************************/
/* CKGEN_PRM */
/*************************************************/
#define DRA72X_CM_CLKSEL_BASE                   0x4AE06100
...
/* WKUPAON_CM */
/*************************************************/
#define DRA72X_CM_WKUPAON_BASE                  0x4AE07800
...
#define DRA72X_PRM_BASE                         0x4AE07D00
...
#define CM_BYPCLK_DPLL_DSP                      0x254
...
#define CM_DIV_H13_DPLL_PER                     0x3160
...
/*************************************************/
#define DRA72X_CM_CORE_BASE                     0x4A008700
...
//#define DRA72X_CM_L3INSTR_BASE                0x4a008E00
...
#define PM_CORE_PWRSTCTL                        0x4AE06700
#define PM_IVA_PWRSTCTL                         0x4AE06F00
#define PM_CAM_PWRSTCTL                         0x4AE07000
#define PM_DSS_PWRSTCTL                         0x4AE07100
#define PM_GPU_PWRSTCTRL                        0x4AE07200
#define PM_L3INIT_PWRSTCTL                      0x4AE07300
#define PM_L4PER_PWRSTCTL                       0x4AE07400
#define PM_CUSTEFUSE_PWRSTCTL                   0x4AE07600
#define PM_VPE_PWRSTCTL                         0x4AE07C80

/*************************************************/
/* Reset Management */
/*************************************************/
#define RM_DSP1_RSTCTRL                         0x4AE06410
#define RM_IPU_RSTCTRL                          0x4AE06510
...
/*************************************************/
#define DRA72X_CTRL_CORE_BASE                   0x4A002000
...
#define CTRL_CORE_OVS_DMARQ_IO_MUX              0xD4C
#define CTRL_CORE_OVS_IRQ_IO_MUX                0xD50
...
#define CTRL_CORE_CONTROL_I2C_0                 0xE04
#define CTRL_CORE_CONTROL_HDMI_TX_PHY           0xE08
#define CTRL_CORE_CONTROL_USB2PHYCORE           0xE1C
#define CTRL_CORE_CONTROL_HDMI_1                0xE20
#define CTRL_DDR3CH1_0                          0xE30
#define CTRL_DDRCH1_0                           0xE38
#define CTRL_DDRCH1_1                           0xE3C
#define CTRL_DDRCH1_2                           0xE48
#define CTRL_DDRIO_0                            0xE50
#define CTRL_CORE_CONTROL_HYST_1                0xE5C
#define CTRL_CORE_SPARE_RW                      0xE68
#define CTRL_CORE_SPARE_R                       0xE6C
#define CTRL_CORE_SRCOMP_NORTH_SIDE             0xE74
#define CTRL_CORE_SRCOMP_SOUTH_SIDE             0xE78
    #define SRCOMP_NORTH_SIDE_USB2PHY_PD        28
#define CTRL_CORE_VIP_MUX_SELECT                0xE8C
#define CTRL_CORE_ALT_SELECT_MUX                0xE90
#define CTRL_CORE_CAMERRX_CONTROL               0xE94
...
#define CTRL_CORE_STD_FUSE_OPP_VDD_DSPEVE_LVT_0 0x1B38
#define CTRL_CORE_STD_FUSE_OPP_VDD_DSPEVE_LVT_1 0x1B3C
#define CTRL_CORE_STD_FUSE_OPP_VDD_DSPEVE_LVT_2 0x1B40
#define CTRL_CORE_STD_FUSE_OPP_VDD_DSPEVE_LVT_3 0x1B44
#define CTRL_CORE_STD_FUSE_OPP_VDD_DSPEVE_LVT_4 0x1B48
#define CTRL_CORE_STD_FUSE_OPP_VDD_IVA_LVT_0    0x1B4C
#define CTRL_CORE_STD_FUSE_OPP_VDD_IVA_LVT_1    0x1B50
#define CTRL_CORE_STD_FUSE_OPP_VDD_IVA_LVT_2    0x1B54
#define CTRL_CORE_STD_FUSE_OPP_VDD_IVA_LVT_3    0x1B58
#define CTRL_CORE_STD_FUSE_OPP_VDD_IVA_LVT_4    0x1B5C
#define CTRL_CORE_STD_FUSE_OPP_VDD_CORE_LVT_0   0x1B60
#define CTRL_CORE_STD_FUSE_OPP_VDD_CORE_LVT_1   0x1B64
#define CTRL_CORE_STD_FUSE_OPP_VDD_CORE_LVT_2   0x1B68
#define CTRL_CORE_STD_FUSE_OPP_VDD_CORE_LVT_3   0x1B6c
#define CTRL_CORE_STD_FUSE_OPP_VDD_CORE_LVT_4   0x1B70
#define CTRL_CORE_LDOSRAM_CORE_4_VOLTAGE_CTRL   0x1B74
#define CTRL_CORE_LDOSRAM_CORE_5_VOLTAGE_CTRL   0x1B78
#define CTRL_CORE_LDOSRAM_DSPEVE_2_VOLTAGE_CTRL 0x1B7C
#define CTRL_CORE_SMA_SW_2                      0x1C04
#define CTRL_CORE_SMA_SW_3                      0x1C08
#define CTRL_CORE_SMA_SW_6                      0x1C14
#define CTRL_CORE_SMA_SW_7                      0x1C18
#define CTRL_CORE_SMA_SW_8                      0x1C1C
#define CTRL_CORE_SMA_SW_9                      0x1C20
#define CTRL_CORE_PCIESS1_PCS1                  0x1C24
#define CTRL_CORE_PCIESS1_PCS2                  0x1C28
#define CTRL_CORE_PCIESS2_PCS1                  0x1C2C
#define CTRL_CORE_PCIESS2_PCS2                  0x1C30
#define CTRL_CORE_PCIE_PCS                      0x1C34
#define CTRL_CORE_PCIE_PCS_REVISION             0x1C38
#define CTRL_CORE_PCIE_CONTROL                  0x1C3C
#define CTRL_CORE_PHY_POWER_PCIESS1             0x1c40
#define CTRL_CORE_PHY_POWER_PCIESS2             0x1c44

#define DRA72X_CTRL_CORE_CONTROL_PBIAS              0x4A002E00
...
/* OCP_SOCKET_PRM                               */
/*************************************************/
#define DRA72X_OCP_SOCKET_PRM_BASE                  0x4AE06000
...
/* DEVICE_PRM                                   */
/*************************************************/
#define DRA72X_DEVICE_PRM_BASE                      0x4AE07D00
...
/* CTRL_MODULE_WKUP                             */
/*************************************************/
#define DRA72X_CTRL_WKUP_BASE                   0x4AE0C000
#define CTRL_WKUP_SEC_CTRL                      0x100
#define CTRL_WKUP_OCPREG_SPARE                  0x10C
#define CTRL_WKUP_PORT_EMIF1_SDRAM_CONFIG       0x110
#define CTRL_WKUP_STD_FUSE_USB_CONF             0x138
#define CTRL_WKUP_STD_FUSE_CONF                 0x13C
#define CTRL_WKUP_EMIF1_SDRAM_CONFIG_EXT        0x144
#define CTRL_WKUP_EMIF1_SDRAM_CONFIG_EXT_1      0x14C
#define CTRL_WKUP_LDOSRAM_MPU_VOLTAGE_CTRL      0x150
...
#define CTRL_WKUP_LDOSRAM_GPU_VOLTAGE_CTRL      0x15C
#define CTRL_WKUP_LDOSRAM_CORE_VOLTAGE_CTRL     0x164
#define CTRL_WKUP_STD_FUSE_DIE_ID_0             0x200
...
#define CTRL_WKUP_STD_FUSE_DIE_ID_1             0x208
#define CTRL_WKUP_STD_FUSE_DIE_ID_2             0x20C
#define CTRL_WKUP_STD_FUSE_DIE_ID_3             0x210
#define CTRL_WKUP_STD_FUSE_PROD_ID_0            0x214
#define CTRL_WKUP_XTAL_OSCILLATOR               0x5AC
...
/*************************************************/
#define DRA72X_CONTROL_PADCONF_CORE_BASE        0x4A003400
...
#define WAKEUP1         0x41C	// Reserved per J6eco TRM
#define WAKEUP2         0x420	// Reserved per J6eco TRM
 ...
 * EMIF register sets
*************************************************/
#define DRA72X_EMIF1_BASE                       0x4C000000
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/dra72x.h $ $Rev: 779097 $")
#endif
