...
#define LPUART_DATA (0x0) /* LPUART Data Register */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/arm/hw_serlpuart.c $ $Rev: 768367 $")
#endif
